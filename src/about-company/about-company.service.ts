...
export class AboutCompanyService {
    constructor(@InjectModel(AboutCompanyModel) private aboutCompanyRepository: typeof AboutCompanyModel) {}

    public async createCompany(dto: CreateAboutCompanyDto): Promise<AboutCompanyModel> {
        return await this.aboutCompanyRepository.create(dto);
    }

    public async setNameCompany(dto: EditNameCompanyDto): Promise<IEditNameCompanyResponse> {
