...
export class MessengersService {
  constructor(
    @InjectModel(MessengerModel)
    private messengerRepository: typeof MessengerModel,
  ) {}
  ...
  private mapMessengerModelToMessangerObj(
    models: MessengerModel[],
  ): IMessenger[] {
    const messengerObjects: IMessenger[] = models.map(
  ...
  public async getAllMessengers(): Promise<IMessenger[]> {
    ...
    const response: IMessenger[] =
      this.mapMessengerModelToMessangerObj(messengers);
    return response;
  }

  public async editMessengerValue(
    dto: EditMessengerValueDto,
  ...
  public async editMessengerName(
    dto: EditMessengerNameDto,
  ...
  public async editMessengerIcon(
    dto: EditMessengerIconDto,
  ...
  public async deleteMessenger(
    dto: DeleteMessengerDto,
